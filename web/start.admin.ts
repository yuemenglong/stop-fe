...
app.ajaxGet("/admin/target-category", transmit);
...
app.ajaxPost("/admin/target-category", transmit);
...
app.ajaxPut("/admin/target-category", transmit);
...
app.ajaxGet("/admin/target", transmit);
...
app.ajaxPost("/admin/target", transmit);
...
app.ajaxPut("/admin/target/:id", transmit);
...
app.ajaxDelete("/admin/target/:id", transmit);
